...
',
    ...
    public static function replaceVariable($content, $obj)
    {
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="bg-green rounded w-auto"><tbody>
        <tr><td align="center" valign="top" class="lh-1"><a href="'.$arrValue['set_password_url']
        .'" class="btn bg-green border-green"><span class="btn-span">Set Password</span>
    ...
    // public static function date_range($start,$end,$weekarray,$excluded_dates)
    // {
    //     $extra_da=0;
    //     $date_range = CarbonPeriod::create($start, $end);
    //     foreach ($date_range as $date) {
    //         if ( in_array($date->dayOfWeek, $weekarray) || in_array($date, $excluded_dates)) {
    //             $extra_da++;
    //         }
