                            ...
                            <li class="nav-item" role="presentation" onclick="alltask()">
                                <a href="#tabs-home-7" class="nav-link active" data-bs-toggle="tab" aria-selected="true"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path d="M17.8 20.817l-2.172 1.138a.392 .392 0 0 1 -.568 -.41l.415
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="col-12 mb-3">
                                                            ...
                                                            <div class="input-icon">
                                                                ...
                                                                <input class="form-control start_date"
                                                                    placeholder="Select a Start date" id="start-date" />
                                                            </div>
                                                        </div>
                                                        <div class="col-12 mb-3">
                                                            <label class="form-label required">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <select type="text" class="form-select task_status"
                                                                    placeholder="Task Status" id="task-status"
                                                                    value="">
                                                                    <option value="">
                                                                        {{ __('Select Status') }}
                                                                    </option>
                                                        ...
                                                        <div class="col-12 mt-4">
                                                            <div class="mb-3">
                                                                <button type="button" class="btn btn-tabler w-100"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <select type="text"
                                                                    ...
                                                                    placeholder="Task Status" id="main_task-status"
                                                                    value="">
                                                                    <option value="">
                                                                        {{ __('Select Status') }}
                                                                    </option>
