        ...
        <div class="row row-cards">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        {{ $data['con_data']->id }}-{{ $data['con_data'] != null ? $data['con_data']->text : 'Task' }}
                        Progress Details
                    </h3>
                </div>
                <div class="card-body">
                    <div class="datagrid">
                        ...
                        <div class="datagrid-item">
                            @php
                                $users_data = $data['con_data']->users != '' ? json_decode($data['con_data']->users) : [];
                            @endphp
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-actions">
                        ...
                        <a href="#" data-size="xl"
                            data-url="{{ route('add_particular_task', ['task_id' => $task_id, 'get_date' => $get_date]) }}"
