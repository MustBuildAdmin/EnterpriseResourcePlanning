...
<script>
    ...
    gantt.showLightbox = function(id) {
        ...
        var reportedto = '';
        if (task.reported_to != null || task.reported_to!=undefined) {
        ...
        var subcontractorto = '';
        if (task.subcontractor != null || task.subcontractor!=undefined) {
    ...
    function save() {
        ...
        task.taskmode = getForm().querySelector("[name='taskmode']:checked").value;
