                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <a class="dropdown-item" href="{{ route('projecttime.tracker', $project_id) }}">
                                    {{ __('Tracker') }}
                                </a>
                                @endif
                                @can('create project task')
                                <a class="dropdown-item" href="{{ route('projects.tasks.index',$project_id) }}">
                                    {{ __('Task') }}
                                </a>
                                @endcan
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <a class="{{ (Request::segment(1) == 'show_consultant_direction')?'active dropdown-item':'dropdown-item'}}" href="{{ route('show_consultant_direction') }}">
                                    {{ __('Directions') }}
                                </a>
                                @endcan

                                @can('manage RFI')
                                <a href="{{ route('rfi_show_info') }}" class="{{ (Request::segment(1) == 'rfi_show_info')?'active dropdown-item':'dropdown-item'}}">{{ __('RFI') }}</a>
                                @endcan

                                <a href="#" class="dropdown-item">{{ __('RAF/RAM') }}</a>
                                <a href="{{ route('procurement_material') }}" class="{{ (Request::segment(1) == 'procurement_material')?'active dropdown-item':'dropdown-item'}}">{{ __('Procurement Material Supply Log') }}</a>
                            </div>
                        </div>
                    </div>
                </li>
