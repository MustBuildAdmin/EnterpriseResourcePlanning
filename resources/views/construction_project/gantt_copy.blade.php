...
<div class="col d-flex flex-column">
    <div class="align">
        ...
        <a href="#" class="btn btn-outline-primary w-20 freeze_button" data-bs-toggle="tooltip"
            title="{{ __('Click to change freeze status') }}" data-original-title="{{ __('Delete') }}"
        ...
        <div>
            <input type='button' class="btn btn-outline-primary w-20" id='default' onclick="toggleChart()"
            ...
            <input type=button value="Zoom Out" class="btn btn-outline-primary w-20"
            ...
            <button onclick="updateCriticalPath(this)" class="btn btn-outline-primary w-20">Expand critical
                tasks</button>
        </div>
                                ...
                                <div class="card card-stats border-0">
                                    ...
                                    @if ($project)
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="gantt_here"
                                                style='width:100%; height:677px;position: relative;'onload="script();">
                                            </div>
                                        </div>
                                    @else
                                        <h1>404</h1>
                    ...
                    $.ajax({
                        ...
                        success: function(multi_data) {
                            $.each(multi_data['0'], function(multi_key, multi_value) {
                                html += "<option value='" + multi_value.key + "'>" +
                                    multi_value.label + "</option>";
                            });
                        }
                    });
                }
