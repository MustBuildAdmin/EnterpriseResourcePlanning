                        ...
                        <div class="card-body">
                            ...
                            <div class="progress progress-sm">
                                <div class="progress-bar bg-primary"
                                    style="width: {{ round($current_Planed_percentage) }}%" role="progressbar"
                                    aria-valuenow="{{ round($current_Planed_percentage) }}" aria-valuemin="0"
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <a
                                                @if (Session::get('current_revision_freeze') == 1) href='{{ route('taskBoard.view', ['list', 'status' => 'comp']) }}' @endif>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <span class="bg-green text-white avatar">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-road" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="2"
                                                    stroke="currentColor" fill="none" stroke-linecap="round"
                                                    stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        ...
                                        <div class="col">
                                            <a
                                                @if (Session::get('current_revision_freeze') == 1) href='{{ route('taskBoard.view', ['list', 'status' => 'ongoing']) }}' @endif>
                                                <div class="font-weight-medium">
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <a
                                                @if (Session::get('current_revision_freeze') == 1) href='{{ route('taskBoard.view', ['list', 'status' => 'remaning']) }}' @endif>
                                                <div class="font-weight-medium">
                                                    {{ __('Total Remaining Sub-Tasks') }}
                                                </div>
                                                <div class="text-muted">
                                                    {{ $total_sub - $completed_task - $ongoing_task }}
                                                    {{ __('Tasks') }}
                                                </div>
                                            </a>
                                        </div>
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <a
                                                @if (Session::get('current_revision_freeze') == 1) href='{{ route('taskBoard.view', ['list', 'status' => 'pending']) }}' @endif>
                                                <div class="font-weight-medium">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <span class="bg-orange text-white avatar">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-route-2" width="24"
                                                    height="24" viewBox="0 0 24 24" stroke-width="2"
                                                    stroke="currentColor" fill="none" stroke-linecap="round"
                                                    stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        ...
                                        <div class="col">
                                            <a
                                                @if (Session::get('current_revision_freeze') == 1) href='{{ route('taskBoard.view', ['list', 'status' => 'dependency_critical']) }}' @endif>
                                                <div class="font-weight-medium">
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <a
                                                @if (Session::get('current_revision_freeze') == 1) href='{{ route('taskBoard.view', ['list', 'status' => 'entire_critical']) }}' @endif>
                                                <div class="font-weight-medium">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        window.ApexCharts && (new ApexCharts(document.getElementById('chart-mentions'), {
            ...
            labels: data,
            colors: [tabler.getColor("red"), tabler.getColor("primary", 0.8), tabler.getColor(
                "green", 0.8)],
            legend: {
                show: false,
            },
