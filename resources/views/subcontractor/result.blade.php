                        ...
                        <div class="d-flex">
                            <a data-bs-toggle="tooltip" data-copy_email="{{ $user->email }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2 text-muted" width="24"
                                    ...
                                    <path
                                        d="M3 5m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2
                                         2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z" />
                                    <path d="M3 7l9 6l9 -6" />
                                </svg> {{ __('Email') }}
                            </a>
                            <a data-bs-toggle="tooltip" data-copy_phone="{{ $user->phone }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2 text-muted" width="24"
                                    ...
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path
                                        d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5
                                         -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15
                                    -15a2 2 0 0 1 2 -2" />
                                </svg> {{ __('Mobile') }}
                            </a>
                        </div>
