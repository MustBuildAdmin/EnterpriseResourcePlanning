                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($modules as $module)
                                            <tr>
                                                <td><input type="checkbox"
                                                        class="form-check-input ischeck diary_checkall"
                                                        data-id="{{ str_replace(' ', '', $module) }}"
                                                        id="{{ str_replace(' ', '', $module) }}"></td>
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($modules as $module)
                                            <tr>
                                                <td><input type="checkbox"
                                                        class="form-check-input ischeck consultant_checkall"
                                                        data-id="{{ str_replace(' ', '', $module) }}"
                                                        id="{{ str_replace(' ', '', $module) }}"></td>
...
<div class="modal-footer">
    ...
    <input type="submit" value="{{ __('Create') }}" class="btn  btn-primary" id="create_role">
</div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('submit', 'form', function() {
          $('#create_role').attr('disabled', 'disabled');
        });
