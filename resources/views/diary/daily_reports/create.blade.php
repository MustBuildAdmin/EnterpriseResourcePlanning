      ...
      <div class="col-12">
        <form class="card" action="{{ route('save_site_reports') }}" enctype="multipart/form-data" method="POST"> @csrf <div class="card-body">
            <div class="row row-cards">
              ...
              <div class="col-sm-6 col-md-4">
                <div class="mb-3">
                  ...
                  <input type="date" name="con_date" class="form-control" id="con_date" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
            ...
            <div class="col-md-6">
              ...
              <input name="prepared_by" placeholder="{{__('Prepared By')}}" class="form-control" type="textbox" />
            </div>
            <div class="col-md-6">
              {{Form::label('Title',__('Title'),array('class'=>'form-label')) }}
              <input name="title" placeholder="{{__('Title')}}" class="form-control" type="textbox" />
            </div>
            </div>
            <br />
