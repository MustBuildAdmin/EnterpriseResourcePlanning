            ...
            <div class="row row-cards">
              ...
              <div class="col-sm-6 col-md-4">
                <div class="mb-3">
                  ...
                  <input type="date" name="con_date" class="form-control" placeholder="Email">
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
              ...
              <div class="col-sm-6 col-md-4">
                <div class="mb-3">
                  ...
                  <div class="dropdownrpt">
                    <select name="weather[]" id='choices-multiple1' class='chosen-select' required multiple>
              ...
              <div class="col-sm-6 col-md-4">
                <div class="mb-3">
                  ...
                  <div class="dropdownrpt">
                    <select name="site_conditions[]" id='choices-multiple1' class='chosen-select' required multiple>
                      <option value="" disabled>Select your option</option>
                      <option value="">Clear</option>
                      <option value="">Dusty</option>
                      <option value="">Muddy</option>
              ...
              <div class="col-sm-6 col-md-2">
                <div class="mb-3">
                  ...
                  <select name="degree" class="form-control addbutton" required>
              ...
              <div class="col-md-12 l-section">
                ...
                <table class="table tableadd form">
                  ...
                  <tbody>
                    <tr id="addRow">
                      <td class="col-xs-3">
                        <input class="form-control addMain" name="position" type="text" placeholder="Enter Posistion Name" />
                      </td>
                      <td class="col-xs-3">
                        <input class="form-control addPrefer" name="no_of_position" type="text" placeholder="Enter NO OF PERSON PER POSISTION" />
                      </td>
                      <td class="col-xs-5">
                        <select class="form-control addbutton addCommon" name="manpower" required>
                          <option value="" disabled selected>Select your option</option>
      ...
      <div class="col-md-12 l-section">
        ...
        <table class="table tableadd form">
          ...
          <tbody>
            <tr id="addRow2">
              <td class="col-xs-3">
                <input name="position_name" class="form-control addMain2" type="text" placeholder="Enter Posistion Name" />
              </td>
              <td class="col-xs-3">
                <input class="form-control addPrefer2" type="text" placeholder="Enter NO OF PERSON PER POSISTION" />
              </td>
              <td class="col-xs-5">
                <select class="type_method" class="form-control addbutton addCommon2" required>
                  <option value="" disabled selected>Select your option</option>
      ...
      <div class="col-md-12 l-section">
        ...
        <table class="table tableadd form">
          ...
          <tbody>
            <tr id="addRow3">
              <td class="col-xs-3">
                <input name="equipment_name" class="form-control addMain3" type="text" placeholder="Enter Equipment Name" />
              </td>
              <td class="col-xs-3">
                <input name="no_of_person_position" class="form-control addPrefer3" type="text" placeholder="Enter NO OF PERSON PER POSISTION" />
              </td>
              <td class="col-xs-5">
      ...
      <div class="col-md-4 form-group">
        ...
        <div class="choose-file ">
          <label for="document" class="form-label">
            <input name="attachements" type="file" class="form-control" name="document" id="document" data-filename="document_create" required multiple>
            <br>
...
<script>
 ...
 $('.forms_doc').validate({
 	rules: {
 		inputimage: {
 			required: true,
 			accept: "png|jpeg|jpg|doc|pdf|exls",
 			filesize: 100000
 		}
 	},
 });
