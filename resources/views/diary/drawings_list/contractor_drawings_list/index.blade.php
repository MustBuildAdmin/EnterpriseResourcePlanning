    ...
    <div class="col-auto ms-auto d-print-none">
       <div class="input-group-btn">
          <a href="#" data-size="xl" data-url="{{ route('add_project_specification',["projectid"=>$projectid]) }}"
            data-ajax-popup="true" data-title="{{__('Create Project Specifications Summary')}}" data-bs-toggle="tooltip"
    ...
    <div class="col-xl-12 mt-3">
       <div class="card table-card">
          <div class="container-fluid">
             ...
             <div class="table">
                <table class="table" id="example2" aria-describedby="contractor drawing">
                   <thead class="">
                      <tr>
                         <th>{{__('S.No')}}</th>
