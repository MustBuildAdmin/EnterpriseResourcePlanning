          ...
          <div class="row">
            ...
            <div class="col">
              <div class="form-group">
                ...
                <input name="issued_by" type="text" class="form-control" placeholder="{{__('Issued By')}}" required/>
              </div>
            </div>
            <div class="col">
              <div class="form-group">
            ...
            <div class="col">
              <div class="form-group">
                ...
                <input name="ad_ae_ref" type="text" class="form-control" placeholder="{{__('AD/ED Reference')}}" required/>
              </div>
            </div>
            <div class="col-12 mt-3">
              <div class="form-group">
                <label for="InputDescription">{{__('AD/ED Description')}} <span style='color:red;'>*</span></label>
                <textarea name="ad_ae_decs" type="text" class="form-control" placeholder="{{__('AD/ED Description')}}" required></textarea>
              </div>
