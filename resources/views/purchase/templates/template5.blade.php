                                    ...
                                    @if($settings['shipping_display']=='on')
                                                <div class="ship_to">
                                                    ...
                                                    <p>
                                                        ...
                                                        {{!empty($vendor->shipping_city)?$vendor->shipping_city:'' . ', '}} {{!empty($vendor->shipping_state)?\App\Models\Utility::getstate_detailsonly_name($vendor->billing_country,$vendor->shipping_state):'' .', '}},{{!empty($vendor->shipping_country)?\App\Models\Utility::getcountry_detailsonly_name($vendor->shipping_country):''}}
                                                    </p>
                                                </div>
                                            @endif
                                </div>
