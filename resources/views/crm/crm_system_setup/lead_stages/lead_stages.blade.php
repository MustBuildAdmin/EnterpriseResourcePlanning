...
<div class="page-wrapper">
    ...
    <div class="row">
       <div class="col-md-6">
          <h2>{{__('Manage Lead Stages')}}</h2>
       </div>
       <div class="col-md-6 float-end ">
          <a class="floatrght btn btn-sm btn-primary" href="#" data-size="md"
             data-url="{{ route('lead_stages.create') }}" data-ajax-popup="true"
             data-bs-toggle="tooltip" title="{{__('Create Lead Stage')}}" >
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="tab-content" id="pills-tabContent">
                                                    ...
                                                    <span class="float-end">
                                                        <div class="ms-2" style="display:flex;gap:10px;">
                                                            ...
                                                            <a href="#" class="btn btn-md"
                                                                data-url="{{ URL::to('lead_stages/'.$lead_stages->id.'
                                                                /edit') }}" data-ajax-popup="true" data-size="md"
                                ...
                                {{__('You can easily change order of lead stage using drag & drop.')}}
                                </p>
                        </div>
                    </div>
                </div>
