                                    ...
                                    <div class="col-auto mb-3 mb-sm-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3 fc-event-title-container">
                                                <h6 class="m-0 text-sm fc-event-title text-primary">{{$task['text']}}</h6>
                                                <small class="text-muted">{{date("d M Y H:i:s", strtotime($task['start_date']))}}  to {{date("d M Y H:i:s", strtotime($task['end_date']))}}</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
