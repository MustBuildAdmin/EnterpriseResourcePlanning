...
<script>
    $(document).ready(function() {
        $("#skill_input").tokenInput("{{route('micro_task_autocomplete')}}", {
        ...
        $("#main_skill_input").tokenInput("{{route('micro_task_autocomplete_main')}}", {
            propertyToSearch:"text",
            tokenValue:"id",
            tokenDelimiter:",",
            hintText: "Search Summary...",
            noResultsText: "Summary not found.",
            searchingText: "Searching...",
            deleteText:"&#215;",
            minChars: 2,
            tokenLimit: 4,
    ...
    function maintask(start_date,end_date,status_task,task_id_arr){
        ...
        $.ajax({
            url : '{{route("micro_main_task_list")}}',
            type : 'GET',
            data : {
                'start_date'  : start_date,
                'end_date'    : end_date,
