...
<div class="row">
  ...
  <div class="col-md-6 float-end floatrght">
        @can('create bank transfer')
            <a class="floatrght btn btn-sm btn-primary" href="#" data-url="{{ route('bank-transfer.create') }}" data-ajax-popup="true" data-title="{{__('Create Bank-Transfer')}}" data-bs-toggle="tooltip" title="{{__('Create')}}">
                                        ...
                                        <div class="ms-2" style="display:flex;">
                                                @can('edit transfer')
                                                    <div class="action-btn ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center backgroundnone" data-url="{{ route('bank-transfer.edit',$transfer->id) }}" data-ajax-popup="true" title="{{__('Edit')}}" data-title="{{__('Edit Transfer')}}" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}">
