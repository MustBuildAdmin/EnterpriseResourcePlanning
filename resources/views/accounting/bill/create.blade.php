                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="bill_date" required  max="{{Carbon\Carbon::now()->format('Y-m-d')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                        <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="due_date" required  max="{{Carbon\Carbon::now()->format('Y-m-d')}}">
