...
<div class="row">
  ...
  <div class="col-md-6 float-end floatrght">
        ...
        @can('create revenue')
            <a href="#" class="floatrght btn btn-sm btn-primary" data-url="{{ route('revenue.create') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Create New Revenue')}}"  data-bs-toggle="tooltip" title="{{__('Create')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select('category',$category,isset($_GET['category'])?$_GET['category']:'', array('class' => 'form-select')) }}
                                        </div>
                                    </div>
