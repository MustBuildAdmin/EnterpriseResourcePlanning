                                ...
                                <div data-v-37eeda86="" class="row">
                                    ...
                                    <div data-v-37eeda86="" class="col-2 text-right">
                                        ...
                                        <p data-v-37eeda86="">
                                            ...
                                            @if($settings['company_city']) <br> {{$settings['company_city']}}, @endif  {{!empty($settings['company_state'])?\App\Models\Utility::getstate_detailsonly_name($settings['company_country'],$settings['company_state']):'',', '}}  @if($settings['company_zipcode']) - {{$settings['company_zipcode']}}@endif
                                            <br>{{!empty($settings['company_country'])?\App\Models\Utility::getcountry_detailsonly_name($settings['company_country']):''}}<br>
