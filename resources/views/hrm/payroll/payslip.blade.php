...
@include('hrm.hrm_main',['hrm_header' => 'Payslip'])
                ...
                {{ Form::open(['route' => ['payslip.store'], 'method' => 'POST', 'id' => 'payslip_form']) }}
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            ...
                            data-bs-toggle="tooltip" title="{{ __('payslip') }}" data-original-title="{{ __('payslip') }}">
                                {{ __('Generate Payslip') }}
                            </a>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <form>
                    <div class="d-flex align-items-center justify-content-start">
                        <h4>{{ __('Find Employee Payslip') }}</h4>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end ms-1 mt-1">
                            {{-- @can('Create Pay Slip') --}}
