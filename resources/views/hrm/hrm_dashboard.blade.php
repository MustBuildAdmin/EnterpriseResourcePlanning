                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row g-3 flex-nowrap team-lists horizontal-scroll-cards">
                            ...
                            <div class="col-auto">
                                <img src="https://demo.rajodiya.com/erpgo/storage/uploads/avatar/avatar.png"
                                    alt="">
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="calendar"
                            class="calendar local_calender fc fc-media-screen fc-direction-ltr fc-theme-bootstrap">
                            <div class="fc-header-toolbar fc-toolbar fc-toolbar-ltr">
                                ...
                                <div class="fc-toolbar-chunk">
                                    <div class="btn-group"><button type="button" title="Day view" aria-pressed="false"
                                            class="fc-timeGridDay-button btn btn-primary">Day</button><button
                                            ...
                                            class="fc-dayGridMonth-button btn btn-primary active">Month</button></div>
                                </div>
                            </div>
                            <div aria-labelledby="fc-dom-1" class="fc-view-harness fc-view-harness-active"
                                style="height: 627.407px;">
                                                        ...
                                                        <div class="fc-scroller fc-scroller-liquid-absolute"
                                                            ...
                                                            <div class="fc-daygrid-body fc-daygrid-body-balanced "
                                                                ...
                                                                <table role="presentation"
                                                                    ...
                                                                    style="width: 845px; height: 570px;">
                                                                    <colgroup></colgroup>
