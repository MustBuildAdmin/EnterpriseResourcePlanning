...
<div class="row">
    @if(\Auth::user()->type !='employee')
        <div class="form-group col-md-6 col-lg-6">
            ...
            {{ Form::select('complaint_from', $employees,null, array('class' => 'form-control  select','required'=>'required','placeholder'=>'Select Employee')) }}
        </div>
    @endif
    <div class="form-group col-md-6 col-lg-6">
...
<div class="modal-footer">
    ...
    <input type="submit" id="edit_compliants" value="{{__('Update')}}" class="btn  btn-primary">
</div>
{{Form::close()}}
<script> 
    $(document).ready(function(){
        $(document).on('submit', 'form', function() {
            $('#edit_compliants').attr('disabled', 'disabled');
        });
    });
</script>
