...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-lg-6 col-md-6 ">
            ...
            {{ Form::select('employee_id', $employees,null, array('class' => 'form-control select2','required'=>'required','placeholder'=>'Select Employee')) }}
        </div>
        <div class="form-group col-lg-6 col-md-6">
...
<div class="modal-footer">
    ...
    <input type="submit" id="edit_transfer" value="{{__('Update')}}" class="btn  btn-primary">
</div>
...
<script> 
    $(document).ready(function(){
        $(document).on('submit', 'form', function() {
            $('#edit_transfer').attr('disabled', 'disabled');
        });
    });
</script>
