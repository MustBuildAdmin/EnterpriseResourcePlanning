...
<div class="row">
  ...
  <div class="col-md-6 float-end floatrght">
    ...
    @can('create job stage')
        <a class="floatrght mb-3 btn btn-sm btn-primary" href="#" data-url="{{ route('job-stage.create') }}" data-ajax-popup="true" data-title="{{__('Create New Job Stage')}}" data-bs-toggle="tooltip" title="{{__('Create')}}">
