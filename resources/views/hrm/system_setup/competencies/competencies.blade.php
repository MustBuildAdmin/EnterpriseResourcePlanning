...
<div class="row">
  ...
  <div class="col-md-6 float-end floatrght">
    ...
    @can('Create Competencies')
        <a class="floatrght mb-3 btn btn-sm btn-primary" href="#" data-url="{{ route('competencies.create') }}" data-ajax-popup="true" data-title="{{__('Create New Competencies')}}" data-bs-toggle="tooltip" title="{{__('Create')}}" >
