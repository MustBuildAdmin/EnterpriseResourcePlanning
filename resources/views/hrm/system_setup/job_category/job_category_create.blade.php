    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <span class="invalid-name show_duplicate_error" role="alert" style="display: none;"> 
                <strong class="text-danger">Category Title Name Already Exist!</strong>
            </span>
            @error('name')
...
<div class="modal-footer">
    ...
    <input type="submit" id="add_job_category" value="{{__('Create')}}" class="btn  btn-primary submit_button">
</div>
{{Form::close()}}
    ...
    $(document).ready(function(){
        $(document).on("keyup", '.get_name', function () {
            ...
            $.ajax({
                ...
                type : 'GET',
                data : { 'get_name' : $(".get_name").val(),'form_name' : "JobCategory" },
        ...
        $(document).on('submit', 'form', function() {
            $('#add_job_category').attr('disabled', 'disabled');
        });
    });
</script>