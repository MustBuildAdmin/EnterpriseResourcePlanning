...
<div class="row">
  ...
  <div class="col-md-6 float-end floatrght">
    ...
    @can('create job category')
        <a class="floatrght mb-3 btn  btn-primary" href="#" data-url="{{ route('job-category.create') }}" data-ajax-popup="true" data-title="{{__('Create New Job Category')}}" data-bs-toggle="tooltip" title="{{__('Create')}}">
