...
<div class="row">
  ...
  <div class="col-md-6 float-end floatrght">
    ...
    @can('create document type')
        <a class="floatrght mb-3 btn  btn-primary"  href="#" data-url="{{ route('document.create') }}" data-ajax-popup="true" data-title="{{__('Create New Document Type')}}" data-bs-toggle="tooltip" title="{{__('Create')}}">
