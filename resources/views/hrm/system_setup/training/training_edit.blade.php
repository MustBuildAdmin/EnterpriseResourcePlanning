    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <span class="invalid-name show_duplicate_error" role="alert" style="display: none;"> 
                <strong class="text-danger">Training Type Name Already Exist!</strong>
            </span>
            @error('name')
...
<div class="modal-footer">
    ...
    <input type="submit" id="edit_training" value="{{__('Update')}}" class="btn btn-primary submit_button">
</div>
{{Form::close()}}
    ...
    $(document).ready(function(){
        $(document).on("keyup", '.get_name', function () {
            ...
            $.ajax({
                ...
                type : 'GET',
                data : { 'get_id': "{{$trainingType->id}}", 'get_name' : $(".get_name").val(), 'form_name' : "TrainingType" },
        ...
        $(document).on('submit', 'form', function() {
            $('#edit_training').attr('disabled', 'disabled');
        });
    });
</script>