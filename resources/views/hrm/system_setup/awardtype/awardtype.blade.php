...
<div class="row">
  ...
  <div class="col-md-6 float-end floatrght">
    ...
    @can('create award type')
        <a class="floatrght mb-3 btn btn-sm btn-primary" href="#" data-url="{{ route('awardtype.create') }}" data-ajax-popup="true" data-title="{{__('Create New Award Type')}}" data-bs-toggle="tooltip" title="{{__('Create')}}">
