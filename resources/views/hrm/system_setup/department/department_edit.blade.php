...
<div class="modal-footer">
    ...
    <input type="submit" id="edit_department" value="{{__('Update')}}" class="btn  btn-primary submit_button">
</div>
{{Form::close()}}
    ...
    $(document).ready(function(){
        $(document).on("keyup", '.get_name', function () {
            ...
            $.ajax({
                ...
                type : 'GET',
                data : { 'get_id': "{{$department->id}}", 'get_name' : $(".get_name").val(), 'form_name' : "Department" },
