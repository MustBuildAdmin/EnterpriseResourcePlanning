...
<div class="row">
  ...
  <div class="col-md-6 float-end floatrght">
    ...
    @can('create department')
        <a class="floatrght mb-3 btn  btn-primary" href="#" data-url="{{ route('department.create') }}" data-ajax-popup="true" data-title="{{__('Create New Department')}}" data-bs-toggle="tooltip" title="{{__('Create')}}">
