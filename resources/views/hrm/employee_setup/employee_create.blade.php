...
@include('hrm.hrm_main',['hrm_header' => 'Employee Create'])
<style>
...
.fulls-card {
            ...
            <div class="card card-fluid">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::textarea('address',old('address'), ['class' => 'form-control','rows'=>2,'required' => 'required']) !!}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body employee-detail-create-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="select2 form-control select2-multiple" id="designation_id" name="designation_id"  requrired data-toggle="select2" data-placeholder="{{ __('Select Designation ...') }}">
    ...
    <div class="row">
        <div class="col-12">
            {!! Form::submit('Create', ['class' => 'mt-3 btn btn-xs badge-blue float-right radius-10px']) !!}
            {{Form::close()}}
        </div>
    </div>
    </div>
