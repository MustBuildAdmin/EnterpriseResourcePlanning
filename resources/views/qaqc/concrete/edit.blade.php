...
<div class="modal-body">
  <div class="row">
    <div class="container">
      ...
      <form class="" action="{{ route('concrete.update_concrete_pouring') }}"
        ...
        <div class="row">
          ...
          <div class="col-6 mb-3">
            <div class="form-group">
              ...
              value="@if($id!='' && $dairy_data->month_year!=''){{$dairy_data->month_year}}@endif"
               required type="month" id="month_year" class="form-control" placeholder="Enter your Month and Year" />
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-6 mb-3">
            <div class="form-group">
              ...
              <input name="date_of_casting" id="date_of_casting" required type="date"
               value="@if($id!='' && $dairy_data->date_of_casting!=''){{$dairy_data->date_of_casting}}@endif"
               class="form-control" placeholder="Enter your Date of Casting" />
              </div>
          </div>
          <div class="col-6 mb-3">
            <div class="form-group">
              <label for="InputElement">{{__('Element of Casting')}} <span style='color:red;'>*</span></label>
              <input name="element_of_casting"
               value="@if($id!='' && $dairy_data->element_of_casting!=''){{$dairy_data->element_of_casting}}@endif"
                required type="text" id="element_of_casting" class="form-control"
                placeholder="Enter your Element of Casting " />
            </div>
          </div>
          ...
          <div class="col-6 mb-3">
            <div class="form-group">
              ...
              <input name="theoretical"
              value="@if($id!='' && $dairy_data->theoretical!=''){{$dairy_data->theoretical}}@endif"
              required type="date" id="theoretical"
              class="form-control" placeholder="Enter your Theoretical Date" />
            </div>
          </div>
          <div class="col-6 mb-3">
            <div class="form-group">
              <label for="InputGrade">{{__('Actual')}} <span style='color:red;'>*</span></label>
              <input name="actual" value="@if($id!='' && $dairy_data->actual!=''){{$dairy_data->actual}}@endif"
               required type="date" class="form-control" id="actual" name="Enter your Actual Date" />
            </div>
          </div>
          <div class="col-6 mb-3">
            <div class="form-group">
              <label for="Inputdays">{{__('7 days Testing Falls on')}}</label>
              <input name="testing_fall_on"
              value="@if($id!='' && $dairy_data->testing_fall!=''){{$dairy_data->testing_fall}}@endif"
              type="date" class="form-control" id="testing_fall_on" disabled />
          ...
          <div class="col-5  mb-3">
            <div class="form-group">
              ...
              <input name=""
              value="@if($id!='' && $dairy_data->total_result!='')
              {{rtrim(str_replace('N/mm2','', $dairy_data->total_result))}}
              @endif" type="text" id="total_result" class="form-control total_result"
              placeholder="{{__('Total Result (Average)')}}"
              @if($format==$today) @else disabled @endif/>
              <input name="total_result"
              value="@if($id!='' && $dairy_data->total_result!='')
               {{rtrim(str_replace('N/mm2','', $dairy_data->total_result))}}
               @endif" type="hidden" id="total_result_back" class="form-control total_result"  />
            </div>
          </div>
