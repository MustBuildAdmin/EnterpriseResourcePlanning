		  ...
		  <div class="row row-cards clients">
			 ...
			 <div class="col-md-6 col-lg-3">
				<div class="card">
				   ...
				   <div class="card-header-right">
					  <div class="btn-group card-option float-end">
						 ...
						 <div class="dropdown-menu dropdown-menu-end">
							...
							@can('edit client')
							<a href="#!" data-size="xl" data-url="{{ route('clients.edit',$client->id) }}" data-ajax-popup="true"
								 class="dropdown-item" data-bs-original-title="{{__('Edit User')}}"> <i class="ti ti-pencil"></i>
								<span>{{__('Edit')}}</span>
							</a>
							@endcan
							@can('delete client')
							...
							{!! Form::close() !!}
							@endcan
							<a href="#!" data-url="{{route('clients.reset',\Crypt::encrypt($client->id))}}" data-ajax-popup="true"
				  ...
				  <img src="{{(!empty($client->avatar))? $profile.\Auth::user()->avatar :
				   ...
				   <div class="d-flex">
					  ...
					  <a data-bs-toggle="tooltip" title="@if($client->clientProjects){{ $client->clientProjects->count() }}@endif"
						class="card-btn">
