...
<head>
    ...
    config('app.name', 'Must BuildApp')}} - @yield('page-title')</title>
    ...
    <link rel="icon" href="{{$logo.'/'.(isset($company_favicon) &&
    !empty($company_favicon)?$company_favicon:'favicon.png')}}" type="image" sizes="16x16">
