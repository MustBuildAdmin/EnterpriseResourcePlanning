...
<head>
  ...
  <title>{{(Utility::companyData($proposal->created_by,'title_text')) ? Utility::companyData($proposal->created_by,'title_text') : config('app.name', 'Must BuildApp')}} - {{__('Proposal')}}</title>
