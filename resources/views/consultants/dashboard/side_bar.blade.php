                ...
                <ul class="navbar-nav pt-lg-3">
                    ...
                    <li class="active nav-item dropdown">
                        ...
                        Request::segment(1) == 'new_vo_change'
                            ? 'dropdown-menu show'
                            : 'dropdown-menu' }}"
                            data-bs-popper="{{ Request::segment(1) == 'new_drawing' ||
                            Request::segment(1) == 'new_rfi' ||
                            Request::segment(1) == 'new_vo_change'
                                ? 'static'
                                : '' }}">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    @can('manage resignation')
                                        <a class="{{ Request::segment(1) == 'new_drawing' ?
                                           'active dropdown-item' : 'dropdown-item' }}"
                                            href="{{ route('new_drawing') }}">
                                            {{ __('Drawing') }}
                                        </a>
                                    @endcan
                                    @can('manage award')
                                        <a class="{{ Request::segment(1) == 'new_rfi' ?
                                           'active dropdown-item' : 'dropdown-item' }}"
                                            href="{{ route('new_rfi') }}">
                                            {{ __('RFI') }}
                                        </a>
                                    @endcan
                                    @can('manage transfer')
                                        <a class="{{ Request::segment(1) == 'new_vo_change' ?
                                           'active dropdown-item' : 'dropdown-item' }}"
                                            href="{{ route('new_vo_change') }}">
                                            {{ __('VO Change Order') }}
                                        </a>
                                    @endcan
                                </div>
