		  ...
		  <div class="col-auto ms-auto d-print-none">
			<form action="{{ route('consultants.index') }}" method="GET">
			  <div class="input-group">
				{{ Form::text('search',isset($_GET['search'])?$_GET['search']:'', array('class'
				=> 'form-control d-inline-block w-9 me-3 mt-auto', 'id'=>'search','placeholder'=>__('Search
				by Name'))) }}
				<div class="input-group-btn">
				  ...
				  <a href="{{ route('consultant.scott-search') }}" class="btn btn-primary"
				  data-bs-toggle="tooltip" title="{{__('Invite Consultant')}}" id="invite"
		  ...
		  <div class="col-md-6 col-lg-3">
			<div class="card">
			  ...
			  <div class="card-header-right">
				<div class="btn-group card-option float-end">
				  ...
				  <div class="dropdown-menu dropdown-menu-end">
					...
					data-ajax-popup="true" data-size="md" class="dropdown-item" data-bs-original-title="{{__('Reset Password')}}">
			  ...
			  <div class="card-body p-4 text-center">
				<?php $short=substr($user->
				  name, 0, 1);?>
				  <?php $short_lname=substr($user->
					lname, 0, 1);?> @if(!empty($user->avatar))
					...
					@endif
					<?php $name=s trlen($user->
					  name) > 20 ? substr($user->name,0,19)."..." : $user->name;?>
					  <h3 class="m-0 mb-1">
						<a href="#">
						  {{ $name }}
						</a>
