        ...
        @else
            ...
            <div class="btn-container">
                <button class="btn accept">
                    <a href="/company-invitation-consultant/{{$checkConnection->id}}/accepted">Accept</a>
                </button>
                <button class="btn decline">
                    <a href="/company-invitation-consultant/{{$checkConnection->id}}/decline">Decline</a>
                </button>
            </div>
        @endif
    </div>
