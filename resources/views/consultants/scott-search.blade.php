        ...
        <div class="col-md-6">
            <div class="col-auto ms-auto d-print-none float-end">
                <div class="input-group-btn">
                    <a id="invite" href="{{ route('consultants.index') }}" class="btn btn-danger"
                    ...
                    <form action="" id="myForm">
                        <div class="p-1 bg-light rounded rounded-pill shadow-sm mb-4">
                            <div class="input-group">
                                <input type="search" id="scott_search" name="search"
                                    value="{{ request()->get('search') }}"
                                    placeholder="Search Consultant Name or Email or Mobile"
