...
<div class="modal-body">
  <div class="row">
    <div class="container">
      ...
      <form class="" action="{{ route('dairy.concrete_pouring') }}" enctype="multipart/form-data" method="POST">
        @csrf
        ...
        <div class="row">
          <div class="col-6">
            <div class="form-group">
              ...
              <label for="InputDate">Project:</label> Project Name
            </div>
          </div>
        ...
        <div class="row">
          ...
          <h4 style="text-align: center; font-weight: 700">Poured</h4>
          <div class="col-6 mb-3">
            <div class="form-group">
