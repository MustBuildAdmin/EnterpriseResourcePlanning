...
<body class=" d-flex flex-column">
	<div class="page">
		...
		<header class="navbar navbar-expand-md  header-navbar sticky-top  d-print-none">
                  <div class="container-fluid">
                    ...
                    <div class="navbar-nav flex-row order-md-last">
                      ...
                      <div class="nav-item dropdown">
						...
						<span class="avatar avatar-sm" style="background: 'url({{(!empty(\Auth::user()->avatar))? $profile.\Auth::user()->avatar: asset(Storage::url("uploads/avatar/avatar.png"))}}')"></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
						  ...
						  <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();" class="dropdown-item">{{__('Logout')}}</a>
