                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('bill_date', __('Bill Date'),['class'=>'form-label']) }}<span style='color:red;'>*</span>
                                        <div class="form-icon-user">
                                            <!-- {{Form::date('bill_date',null,array('class'=>'form-control','required'=>'required'))}} -->
                                            <input type="date" class="form-control" placeholder="dd/mm/yyyy" required name="bill_date"  max="{{Carbon\Carbon::now()->format('Y-m-d')}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            <input type="date" class="form-control" placeholder="dd/mm/yyyy" required name="due_date"  max="{{Carbon\Carbon::now()->format('Y-m-d')}}">
                                ...
                                <input type='hidden' name='user_id' id='user_id' value={{$bill->vender_id}}>
...
{{--                                <div class="col-md-6">--}}
{{--                                    <div class="form-group">--}}
{{--                                        {{Form::label('sku',__('SKU')) }}--}}<span style='color:red;'>*</span>
