                                        ...
                                        @if ($settings['shipping_display'] == 'on')
                                            <div class="ship_to">
                                                ...
                                                <p>
                                                    ...
                                                    {{!empty($customer->shipping_state)?\App\Models\Utility::getstate_detailsonly_name($customer->billing_country,$customer->shipping_state):'' .', '}},{{!empty($customer->shipping_country)?\App\Models\Utility::getcountry_detailsonly_name($customer->shipping_country):''}}<br>
                                                </p>
                                            </div>
                                        @endif
                                    </div>
